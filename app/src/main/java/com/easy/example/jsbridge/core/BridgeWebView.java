...
public class BridgeWebView extends WebView implements WebViewJavascriptBridge, BridgeWebViewClient.OnLoadJSListener,IWebView {
...
//        mContent.setLayerType(View.LAYER_TYPE_SOFTWARE, null);
        ...
        mClient = new BridgeWebViewClient(this,this);
