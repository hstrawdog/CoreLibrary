...
import com.hqq.example.databinding.ActivitySpinnerBinding
...
class SpinnerActivity : BaseViewBindingActivity<ActivitySpinnerBinding>() {
    ...
    private fun initSpinner() {
        //声明一个下拉列表的数组适配器
        val starAdapter = ArrayAdapter(this, com.hqq.example.R.layout.item_select, starArray)
        //设置数组适配器的布局样式
        starAdapter.setDropDownViewResource(com.hqq.example.R.layout.item_dropdown)
        //从布局文件中获取名叫sp_dialog的下拉框
        val sp: Spinner = findViewById(com.hqq.example.R.id.spinner)
