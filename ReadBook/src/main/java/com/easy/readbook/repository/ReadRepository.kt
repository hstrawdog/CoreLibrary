...
object ReadRepository {
    @JvmStatic
    fun getBookRecord(book: com.easy.readbook.room.entity.Book): LocalRecord? {
    ...
    @JvmStatic
    fun saveBookRecord(book: com.easy.readbook.room.entity.Book, localRecord: LocalRecord) {
