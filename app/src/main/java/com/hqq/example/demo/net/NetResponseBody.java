 ...
 * @Descrive :
 */
public class NetResponseBody<T> {
    ...
    public NetResponseBody setReason(String reason) {
        this.reason = reason;
        return this;
    }
    ...
    public NetResponseBody setResult(T result) {
        this.result = result;
        return this;
    }
    ...
    public NetResponseBody setError_code(int error_code) {
