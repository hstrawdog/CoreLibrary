...
import com.easy.core.utils.sp.SharedPreferencesUtil
...
class ReadSettingManager private constructor() {
    ...
    var pageMode: com.easy.readbook.weight.page.PageMode
        get() {
            val mode = SharedPreferencesUtil.getObject(CoreConfig.applicationContext,
                SHARED_READ_PAGE_MODE,
                com.easy.readbook.weight.page.PageMode.SIMULATION.ordinal) as Int
            return com.easy.readbook.weight.page.PageMode.values()[mode]
        }
