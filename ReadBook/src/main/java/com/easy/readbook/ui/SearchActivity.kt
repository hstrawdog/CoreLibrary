    ...
    override fun initData() {
        ...
        viewMode.bookNames.observe(this) {
            val tagAdapter = object : com.easy.readbook.weight.flowlayout.TagAdapter<String>(it) {
                override fun getView(parent: com.easy.readbook.weight.flowlayout.FlowLayout?, position: Int, string: String): View {
        ...
        binding.flBooks.setOnSelectListener(object : com.easy.readbook.weight.flowlayout.TagFlowLayout.OnSelectListener {
