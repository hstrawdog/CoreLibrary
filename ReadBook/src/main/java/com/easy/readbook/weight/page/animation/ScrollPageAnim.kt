...
class ScrollPageAnim(
...
) : com.easy.readbook.weight.page.animation.PageAnimation(w, h, marginWidth, marginHeight, view, listener) {
    ...
    private fun onLayout() {
        ...
        if (mActiveViews.size == 0) {
            fillDown(0, 0)
            mDirection = com.easy.readbook.weight.page.animation.PageAnimation.Direction.NONE
        } else {
    ...
    private fun fillDown(bottomEdge: Int, offset: Int) {
        ...
        while (downIt!!.hasNext()) {
            ...
            if (view.bottom <= 0) {
                ...
                if (mDirection == com.easy.readbook.weight.page.animation.PageAnimation.Direction.UP) {
        ...
        while (realEdge < mViewHeight && mActiveViews.size < 2) {
            ...
            mDirection = com.easy.readbook.weight.page.animation.PageAnimation.Direction.DOWN
            // 设置Bitmap的范围
            view.top = realEdge
    ...
    private fun fillUp(topEdge: Int, offset: Int) {
        ...
        while (upIt!!.hasNext()) {
            ...
            if (view.top >= mViewHeight) {
                ...
                if (mDirection == com.easy.readbook.weight.page.animation.PageAnimation.Direction.DOWN) {
                    mListener.pageCancel()
                    mDirection = com.easy.readbook.weight.page.animation.PageAnimation.Direction.NONE
                }
            }
