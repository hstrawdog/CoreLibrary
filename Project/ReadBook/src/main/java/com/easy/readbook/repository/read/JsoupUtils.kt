package com.easy.readbook.repository.read

import android.text.Html
import com.easy.core.utils.log.LogUtils
import com.easy.readbook.bean.*
...
import com.easy.readbook.utils.MD5Utils
...
object JsoupUtils {
     ...
     * @return Book
     */
    fun doReadBook(element: JXNode, jsonElement: BookInfoRule, sourceName: String): com.easy.readbook.room.entity.Book? {
        val book = com.easy.readbook.room.entity.Book()
        jsonElement.apply {
     ...
     */
    fun readChapter(requestUrl: String, html: String, source: BookSource?, book: com.easy.readbook.room.entity.Book): ArrayList<com.easy.readbook.room.entity.Chapter> {
        val chapters = ArrayList<com.easy.readbook.room.entity.Chapter>()
        if (source != null) {
            ...
            if (chapterElement != null) {
                ...
                if (list != null) {
                    for ((index, child) in list.withIndex()) {
                        val chapter = com.easy.readbook.room.entity.Chapter()
                        chapter.apply {
     ...
     * @return Book
     */
    fun getBookDetail(html: String, book: com.easy.readbook.room.entity.Book, source: BookSource): com.easy.readbook.room.entity.Book {
