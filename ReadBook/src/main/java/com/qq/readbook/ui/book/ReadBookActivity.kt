...
import com.qq.readbook.down.DownChapter
import com.qq.readbook.down.DownService
        ...
        override fun onServiceConnected(name: ComponentName?, service: IBinder?) {
            ...
            if (taskBuilder?.onDownloadListener == null) {
                taskBuilder?.onDownloadListener = object : DownService.OnDownloadListener {
                    override fun onSuccess(boolean: Boolean, downChapter: DownChapter, chapter: Chapter) {
