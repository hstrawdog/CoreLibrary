package com.hqq.example.utils.keyboard;
...
import com.hqq.example.utils.ScreenUtils;
 ...
 */
public class SoftHideKeyboardRedraw {

    public static void assistActivity(Activity activity) {
        new SoftHideKeyboardRedraw(activity);
    }

    public static void assistActivity(Activity activity, FrameLayout content) {
        new SoftHideKeyboardRedraw(activity, content);
    }
    ...
    private SoftHideKeyboardRedraw(Activity activity) {
        this(activity, (FrameLayout) activity.findViewById(android.R.id.content));
    }

    private SoftHideKeyboardRedraw(Activity activity, FrameLayout content) {
