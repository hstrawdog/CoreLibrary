...
import com.easy.core.lifecycle.BaseService
import com.easy.core.utils.log.LogUtils
import com.easy.readbook.Keys
import com.easy.readbook.repository.BookArticleRepository
...
class DownService : BaseService() {
    ...
    override fun onBind(intent: Intent): IBinder {
        val book = intent.getParcelableExtra<com.easy.readbook.room.entity.Book>(Keys.BOOK)
     ...
     */
    private fun processChapter(book: com.easy.readbook.room.entity.Book, downChapter: DownChapter) {
        CoroutineScope(Dispatchers.IO).launch {
            // 收到新的通知  清空统计
            LogUtils.e4Debug("processChapter:   ")
            for (chapter in ArrayList<com.easy.readbook.room.entity.Chapter>().apply { addAll(downChapter.list) }) {
                if (bind) {
     ...
     */
    private suspend fun doGet(chapter: com.easy.readbook.room.entity.Chapter, book: com.easy.readbook.room.entity.Book, downChapter: DownChapter) {
     ...
     * 发送数据给Activity
     */
    private fun sendSuccess(boolean: Boolean, downChapter: DownChapter, chapter: com.easy.readbook.room.entity.Chapter) {
    ...
    open class TaskBuilder : Binder() {
         ...
         * 2 缓存  回调给界面  现在进度
         */
        fun sendLoadMessage(model: Int, list: List<com.easy.readbook.room.entity.Chapter>) {
    ...
    interface OnDownloadListener {
         ...
         */
        fun onSuccess(boolean: Boolean, downChapter: DownChapter, chapter: com.easy.readbook.room.entity.Chapter)
    }
