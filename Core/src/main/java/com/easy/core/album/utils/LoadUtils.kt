...
object LoadUtils {
    ...
    fun loadImage(path: Uri?, picture: ImageView) {
        val options = RequestOptions().placeholder(R.drawable.ic_def_img)
    ...
    fun loadLocalMediaPath(localMediaType: Int, path: Uri?, picture: ImageView) {
        if (localMediaType == com.easy.core.album.annotation.LocalMediaType.VALUE_TYPE_IMAGE) {
            loadImage(path, picture)
        } else if (localMediaType == com.easy.core.album.annotation.LocalMediaType.VALUE_TYPE_VIDEO) {
