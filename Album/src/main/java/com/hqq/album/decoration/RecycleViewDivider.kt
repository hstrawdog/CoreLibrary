...
class RecycleViewDivider(context: Context, orientation: Int) : ItemDecoration() {
     ...
     */
    constructor(context: Context, orientation: Int, dividerHeight: Int,
                dividerColor: Int) : this(context, orientation) {
    ...
    private fun drawHorizontal(canvas: Canvas, parent: RecyclerView) {
        ...
        for (i in 0 until childSize - foodNum) {
    ...
    fun setFoodNu(foodNu: Int): RecycleViewDivider {
        foodNum = foodNu
        return this
    }
