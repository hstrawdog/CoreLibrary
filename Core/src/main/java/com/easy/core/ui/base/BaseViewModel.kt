...
abstract class BaseViewModel : ViewModel(), IBaseViewModel {
    ...
    init {
        LogUtils.dMark( tag = TAG.LIVE_TAG, block = { "${this.toString()} BaseViewModel  init "  })
    }
    ...
    override fun onCreate(owner: LifecycleOwner) {
       ...
       LogUtils.dMark( tag = TAG.LIVE_TAG, block = { "${this.toString()} BaseViewModel           onCrete " })
    }

    override fun initData(extras: Bundle?) {
        bundle = extras
       LogUtils.dMark( tag = TAG.LIVE_TAG, block = { "${this.toString()} BaseViewModel           initData " })
    }
