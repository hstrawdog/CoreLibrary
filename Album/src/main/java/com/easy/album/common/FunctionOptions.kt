...
import com.easy.album.activity.AlbumDirectoryActivity
import com.easy.album.activity.AlbumFolderActivity
...
class FunctionOptions {
     ...
     * 默认显示的图片
     */
    var albumType = com.easy.album.annotation.LocalMediaType.VALUE_TYPE_IMAGE
        private set
    ...
    private fun rest() {
        ...
        isStartUpCamera = false
        maxSelectNum = 9
        albumType = com.easy.album.annotation.LocalMediaType.VALUE_TYPE_IMAGE
    }
