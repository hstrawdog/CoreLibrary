                ...
                if (isMove) {
                    ...
                    if (mMoveX == 0 && mMoveY == 0) {
                        ...
                        if (x - mStartX > 0) {
                            ...
                            direction = com.easy.readbook.weight.page.animation.PageAnimation.Direction.PRE
                            //如果上一页不存在
                            if (!hasPrev) {
                                noNext = true
                                return true
                            ...
                            //如果存在设置动画方向
                            direction = com.easy.readbook.weight.page.animation.PageAnimation.Direction.NEXT
