...
public class MyCropImageView extends ImageView {
    private static final String TAG = MyCropImageView.class.getSimpleName();
    ...
    private static final int TRANSLUCENT_BLACK = 0x33000000;
     ...
     * 自由移动下边框触发大小
     */
    private int mShadowsEnabledSize = 30;
    // Constructor /////////////////////////////////////////////////////////////////////////////////
...
//    canvas.drawCircle(mFrameRect.left, mFrameRect.top, mHandleSize, mPaintFrame);
        ...
        canvas.drawRect(mFrameRect.left, mFrameRect.top - 8, mFrameRect.left + 35, mFrameRect.top, mPaintFrame);
        canvas.drawRect(mFrameRect.left - 8, mFrameRect.top - 8, mFrameRect.left, mFrameRect.top + 35, mPaintFrame);


//    canvas.drawCircle(mFrameRect.right, mFrameRect.top, mHandleSize, mPaintFrame);
        canvas.drawRect(mFrameRect.right, mFrameRect.top - 8, mFrameRect.right - 35, mFrameRect.top, mPaintFrame);
        canvas.drawRect(mFrameRect.right + 8, mFrameRect.top - 8, mFrameRect.right, mFrameRect.top + 35, mPaintFrame);

//    canvas.drawCircle(mFrameRect.left, mFrameRect.bottom, mHandleSize, mPaintFrame);
        canvas.drawRect(mFrameRect.left-8, mFrameRect.bottom , mFrameRect.left + 35, mFrameRect.bottom+8, mPaintFrame);
        canvas.drawRect(mFrameRect.left - 8, mFrameRect.bottom , mFrameRect.left, mFrameRect.bottom - 35, mPaintFrame);

//    canvas.drawCircle(mFrameRect.right, mFrameRect.bottom, mHandleSize, mPaintFrame);

        canvas.drawRect(mFrameRect.right, mFrameRect.bottom + 8, mFrameRect.right - 35, mFrameRect.bottom, mPaintFrame);
        canvas.drawRect(mFrameRect.right + 8, mFrameRect.bottom + 8, mFrameRect.right, mFrameRect.bottom - 35, mPaintFrame);
...
//    canvas.drawCircle(rect.right, rect.bottom, mHandleSize, mPaintFrame);
     ...
     * @return Builder
     */
    public MyLoadRequest load(Uri sourceUri) {
        return new MyLoadRequest(this, sourceUri);
    }
     ...
     * @return Builder
     */
    public MyCropRequest crop(Uri sourceUri) {
        return new MyCropRequest(this, sourceUri);
    }
     ...
     * @return Builder
     */
    public MySaveRequest save(Bitmap bitmap) {
        return new MySaveRequest(this, bitmap);
    }
