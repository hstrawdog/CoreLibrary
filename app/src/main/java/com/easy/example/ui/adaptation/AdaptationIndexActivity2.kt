...
class AdaptationIndexActivity2(override val adapter: MainAdapter = MainAdapter()) :
    ...
    override fun initData() {
        ...
        adapter.add(com.easy.example.bean.MainBean("Compose List 验证", ComposeListDemoActivity::class.java))
        ...
        adapter.add(com.easy.example.bean.MainBean("Compose Toolbar 宿主验证", ComposeToolbarHostCatalogActivity::class.java))
