...
import com.easy.core.album.activity.AlbumPreviewActivity
import com.easy.core.album.annotation.LocalMediaType
import com.easy.core.album.common.Album
import com.easy.core.album.common.AlbumPhotoCallBack
import com.easy.core.album.dialog.PhotoDialog.Companion.getSelectPhotoDialog
import com.easy.core.album.utils.AlbumFileUtils.getFile2Uri
...
class AlbumIndexActivity : BaseActivity() {
    ...
    private fun openCameraAndAlbum(view: View) {
        Album.from(com.easy.core.album.annotation.LocalMediaType.VALUE_TYPE_IMAGE)
    ...
    fun openVideoAlbum(view: View?) {
        Album.from(com.easy.core.album.annotation.LocalMediaType.VALUE_TYPE_VIDEO)
            .forResult(call)
    }
