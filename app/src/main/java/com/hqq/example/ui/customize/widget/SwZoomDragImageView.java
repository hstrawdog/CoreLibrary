...
public class SwZoomDragImageView extends androidx.appcompat.widget.AppCompatImageView implements View.OnTouchListener{
    ...
    private void initData() {
        ...
        this.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                mInitializationScalePoint.set( getWidth() / 2, viewY + getHeight() / 2);//初始化缩放位置
